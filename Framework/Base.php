...
namespace Framework
{
    ...
    /*
     * Classe que serà la base de totes les demés que creem en el
     * nostre FWk
     */
    class Base
    {
        ...
        {
            //Crea un nou Inspector
            $this->_inspector = new Inspector($this);
            
            if (is_array($options) || is_object($options))
            {
                //Creo els mètodes per a totes les propietats pasades.
        ...
        {
            //S'ha definit l'Inspector?
            if (empty($this->_inspector))
            {
                throw new Exception("Call parent::__construct!");
            }
            //Cerco si el nom de la funció està ben definit: comença per "get" i te lletres
            //o numeros
            ...
            if (sizeof($getMatches) > 0) {
                ...
                //bool property_exists ( mixed $class , string $property ) Font: PHP.NET
